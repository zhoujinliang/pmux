...
use gpui::{
    App, Bounds, Edges, Font, FontFeatures, FontStyle, FontWeight, Hsla, Pixels, Point, TextAlign,
    ...
    pub fn paint(
        ...
        for line_idx in 0..num_lines {
            ...
            for (col_idx, cell) in cells_vec.iter() {
                ...
                let _ = shaped_line.paint(Point { x, y }, self.cell_height, TextAlign::default(), None, window, _cx);
            }
        }
