...
**测试时间:** Mon Mar  2 08:06:48 CST 2026
**Git Commit:** be3a5a5
**分支:** main
...
- ✅ **3: No staircase**: PASS
- ✅ **4a: Main marker**: PASS
- ✅ **4b: Multiple windows**: PASS
- ✅ **4c: Second window**: PASS
- ✅ **4d: Both have panes**: PASS
- ✅ **4e: Second window input**: PASS
- ✅ **4f: Main still works**: PASS
- ✅ **5a: Session persists**: PASS
- ✅ **5b: Capture content**: PASS
- ✅ **5c: Window preserved**: PASS
- ✅ **6a: Recovery window**: PASS
- ✅ **6b: Recovery content**: PASS
- ✅ **6c: Recovery not blank**: PASS
